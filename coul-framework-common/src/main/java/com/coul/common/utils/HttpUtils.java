...
//package com.ctg.bss.common.utils;
//
//import com.ctg.bss.common.exception.RtManagerException;
...
//                return strRet;
//            } else {
//                throw new Exception("调用http服务错误，返回码" + String.valueOf(statusCode) + "返回内容："
