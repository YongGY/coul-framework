...
<script type="text/javascript"
	src="<%=basePath%>js/jquery/jquery-1.11.2.min.js"></script>
...
<body>
	...
	<div id="producer">
		...
		<button onclick="send('queueSender.html')">发送的Queue</button>

		<button onclick="send('topicSender.html')">发送的Topic</button>
